...
jQuery(document).ready(function () {
  ...
  }), $(".select-drop").selectbox(), $(".datepicker").datepicker({ startDate: "dateToday", autoclose: !0 }), $(document).ready(function (e) {
    e(".counter").counterUp({ delay: 10, time: 2e3 });
  }), jQuery(document).ready(function () {
    $("#price-range").slider({ range: !0, min: 20, max: 300, values: [20, 300], slide: function slide(e, a) {
  ...
  });var a = $(".singlePackage .panel-heading i.fa");$(".singlePackage .panel-heading").click(function () {
    a.removeClass("fa-minus").addClass("fa-plus"), $(this).find("i.fa").removeClass("fa-plus").addClass("fa-minus");
  });var i = $(".accordionWrappar .panel-heading i.fa");$(".accordionWrappar .panel-heading").click(function () {
    i.removeClass("fa-minus").addClass("fa-plus"), $(this).find("i.fa").removeClass("fa-plus").addClass("fa-minus");
  });var o = $(".solidBgTitle .panel-heading i.fa");$(".solidBgTitle .panel-heading").click(function () {
    o.removeClass("fa-minus").addClass("fa-plus"), $(this).find("i.fa").removeClass("fa-plus").addClass("fa-minus");
  });var s = $(".accordionSolidTitle .panel-heading i.fa");$(".accordionSolidTitle .panel-heading").click(function () {
  ...
  });var l = $(".accordionSolidBar .panel-heading i.fa");$(".accordionSolidBar .panel-heading").click(function () {
  ...
  }), $("#simple_timer").syotimer({ year: 2018, month: 5, day: 9, hour: 20, minute: 30 }), $(".incr-btn").on("click", function (e) {
    var a,
        i = $(this),
        o = i.parent().find(".quantity").val();i.parent().find(".incr-btn[data-action=decrease]").removeClass("inactive"), "increase" === i.data("action") ? a = parseFloat(o) + 1 : o > 1 ? a = parseFloat(o) - 1 : (a = 0, i.addClass("inactive")), i.parent().find(".quantity").val(a), e.preventDefault();
  }), $(".slick-carousel").slick({ centerMode: !0, centerPadding: "100px", slidesToShow: 1, responsive: [{ breakpoint: 1024, settings: { slidesToShow: 1, slidesToScroll: 1, infinite: !0 } }, { breakpoint: 768, settings: { slidesToShow: 1, slidesToScroll: 1 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1, centerMode: !1 } }] }), $(".brandSlider").slick({ slidesToShow: 4, slidesToScroll: 1, centerMode: !0, centerPadding: "0px", responsive: [{ breakpoint: 1024, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: !0 } }, { breakpoint: 768, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } }] }), $(".google-maps").click(function () {
...
})(window, document, 'script', 'https://www.google-analytics.com/analytics.js', 'ga');ga('create', 'UA-71155940-4', 'auto');ga('send', 'pageview');(function (w, i, d, g, e, t, s) {
