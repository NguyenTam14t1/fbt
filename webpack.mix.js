...
mix.js('resources/js/app.js', 'public/js')
   ...
   .copy('resources/js/bookingtour/modernizr.custom.js', 'public/templates/bookingtour/js/modernizr.custom.js')
   ...
   .js('resources/js/admin/plugins.js', 'public/templates/admin/js/plugins.js')
   .copyDirectory('resources/sass/plugins', 'public/templates/plugins');
